...
const Dogs = () => (
    <div className="content">
        <section className="sectionLeft">
            <img src="/assets/images/Dog1.jpg" alt="Dog 1" className="sectionImage" />
        ...
        <section className="sectionRight">
            <img src="/assets/images/Dog2.jpg" alt="Dog 2" className="sectionImage" />
            <div className="sectionText">
                <h2>Diet & Exercise</h2>
                <p>
        ...
        <section className="sectionLeft">
            <img src="/assets/images/Dog3.jpg" alt="Dog 3" className="sectionImage" />
            <div className="sectionText">
        ...
        <section className="sectionRight">
            <img src="/assets/images/Dog4.jpg" alt="Dog 4" className="sectionImage" />
            <div className="sectionText">
